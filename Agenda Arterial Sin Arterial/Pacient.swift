...
class Pacient {
    ...
    func changeInfoPatient(newName : String, newPatName : String, newMatName : String, newPhoto : String, newSex : String, newBirthDate : Date, newPhone : String,  newHeight : Double, newWeight : Double, newCirAbdominal : Double, newMedDisease : String, newBloodType : String,  newNextAppointment : Date) -> (Bool, String){
        if newName == "" {
