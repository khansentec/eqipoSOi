...
class Capture : Identifiable{
    ...
    func validateMedition (med : Medition,
                           ...
                           presionSupStr3 : String, presionInfStr3 : String, pulso3 : Int) -> (Bool, String, Medition){
                      
        var newMed : Medition = med
        ...
        // If no alert message, add first capture to medition and validate second capture
        if currValidationStatus {
            ...
            newMed.agregarCaptura(nuevaCaptura: cap1)
        ...
        // If still no alert message, validate third capture
        if currValidationStatus {
            ...
            newMed.agregarCaptura(nuevaCaptura: cap2)
        ...
        if currValidationStatus {
            ...
            newMed.agregarCaptura(nuevaCaptura: cap3)
        }
        
        return (currValidationStatus, currAlertMessage, newMed)
    }
}
