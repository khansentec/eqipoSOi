...
struct CapturesView: View {
    ...
    func determinarTiempo(numCaptura : Int) -> Int{
    ...
    var body: some View {
                ...
                VStack(alignment: .leading, spacing: 6){
                    ...
                    HStack {
                        ...
                        TextField("Inferior", text: $presionInfStr1)
                            ...
                            .disabled(!estado)
                        Button(action:{
                            tiempoRestante = determinarTiempo(numCaptura : 1)
                        }) {
                    ...
                    HStack {
                        ...
                        TextField("Inferior", text: $presionInfStr2)
                            ...
                            .disabled(!estado)
                        Button(action:{
                            tiempoRestante = determinarTiempo(numCaptura : 2)
                        }) {
                            Image(systemName: "clock")
                                .imageScale(.large)
                                .foregroundColor(.blue)
                    ...
                    HStack {
                        ...
                        Button(action:{
                            tiempoRestante = determinarTiempo(numCaptura : 3)
                        }) {
                            Image(systemName: "clock")
                                .imageScale(.large)
                                .foregroundColor(.blue)
        ...
        if temporizador {
            ZStack{
                ...
                VStack {
                    Text(convertirSegundosATiempo(tiempoRestanteSegundos: tiempoRestante))
                        .font(.system(size: 50))
