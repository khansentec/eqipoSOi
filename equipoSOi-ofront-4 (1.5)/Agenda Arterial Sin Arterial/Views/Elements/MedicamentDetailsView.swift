        ...
        VStack(alignment : .trailing){
            ...
            VStack(alignment : .leading, spacing : 20){
                ...
                HStack{
                    ...
                    // .padding(.trailing,200).disabled(!editing)
                        .padding(.trailing,device == .pad ? 230 : 70).disabled(!editing)
                ...
                HStack{
                    ...
                    //   .frame(maxWidth: widthMenu == 375 ? 270 : 270, maxHeight: 300, alignment: .leading)
                        .frame(maxWidth: device == .phone ? 375 : widthMenu == 1024 ? 590 : 590, maxHeight: 300, alignment: .leading)
