    ...
    var body: some View {
        ...
        ZStack{
            VStack(alignment: .center){
                Text("Capturas De Presión").font(.system(size: device == .pad ? 35: widthMenu == 375 ? 20 : 20)).bold()
                ScrollView(.vertical, showsIndicators: false){
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible(), spacing: 20), count: 1), spacing: 20){
                        VStack() {
                            VStack(alignment: .leading, spacing: 6){
                                HStack{
                                    Text("¿Se encuentra relajado?").font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                        .padding(.bottom,5)
                                    Picker(selection: $status, label: Text("Picker")) {
                                        Text("Sí").tag(true)
                                        Text("No").tag(false)
                                    }.frame(width : 80, height: 10).scaledToFit().scaleEffect(CGSize(width: 1.5 ,height: 1.5))
                                        .accentColor(.blue)
                                        .padding(.top,-5)
                                        .font(.system(size: device == .pad ? 28: widthMenu == 375 ? 16 : 16))
                                }
                                
                                Text("Si selecciono 'No', no debe hacerse la captura en este momento").font(.system(size: device == .pad ? 24: widthMenu == 375 ? 16 : 16))
                                    .padding(.bottom,20)
                                    .font(.system(size : 10))
                                    .multilineTextAlignment(.leading)
                                    .padding(.trailing, 30)
                                HStack {
                                    Text("Captura 1").font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                    
                                    TextField("Superior", text: $presionSupStr1)
                                        .font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                        .frame(width:device == .pad ? 150 : 65)
                                ...
                                HStack{
                                    Text("Pulso").font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                ...
                                HStack {
                                    Text("Captura 2").font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                ...
                                HStack {
                                    Text("Captura 3").font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                            ...
                            Text("Ingresa la fecha y hora:").font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                .padding(.bottom,20)
                            ...
                            DatePicker("", selection: $dateCapture)
                                ...
                                .foregroundColor(.blue)
                                .padding(.bottom,20)
                            // iPhone .padding(.trailing,70)
                            // .padding(.trailing 460)
                                .padding(.trailing,widthMenu == 1024 ? 380 :260)
                                .padding(.leading,0)
                                .font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
...
//                                    }
                                ...
                                .font(.system(size: device == .pad ? 28: widthMenu == 375 ? 18 : 18))
                                .frame(height: device == .pad ? 100 : widthMenu == 375 ? 70: 70)
